...
},{}],"biojs-vis-rnasequences":[function(require,module,exports){
    ...
    function drawText(fileData, canvasName, start, end) {
    	...
    	for (var i = startRow; i < endRow; i++) {	
    		if ($.inArray(fileData[i], genesGraphArray) != -1){
    			...
    			context.fillRect(0, ((i - startRow) * textHeightPixelSize), canvas.width, textHeightPixelSize);
    		}
  	...
  	.click(function(e){
		...
		if ($.inArray( fileData[selectedLineNumber], genesGraphArray) != -1){
			...
			var canvas = document.getElementById('textCanvas');
   			var context = canvas.getContext('2d');
   			context.clearRect(0, ((selectedLineNumber - secondZoomStartRow) * textHeightPixelSize), canvas.width, textHeightPixelSize);
 				
 			context.fillStyle = "black";
 			context.fillText(fileData[selectedLineNumber][0], 0, (selectedLineNumber - secondZoomStartRow + 0.8) * textHeightPixelSize);
		} 
		else {
			...
			//$(this).css({"z-index":"1", "border":"1px solid #000"});
  			...
  			var canvas = document.getElementById('textCanvas');
       		...
       		context.fillStyle = "yellow";
 			context.fillRect(0, ((selectedLineNumber - secondZoomStartRow) * textHeightPixelSize), canvas.width, textHeightPixelSize - 1);
